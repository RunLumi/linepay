...
struct AboutLinePayView: View {
    var body: some View {
        List {
            ...
            Section {
                ComparisonScopeView()
                Text(ComparisonScopeDisclosure.safeUse).font(.footnote)
            }
            Section {
