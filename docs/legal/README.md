...
**Status (September 7, 2026):** PR #34 was merged into `main` as `19264cf0728a01bd3ee6cacda291ebeff692622b`; PR #57 was subsequently squash-merged as `79c5ed4a067276bd7c4388653e80ef1f98f44e7c`. The merged engineering tree includes the Picker/accessibility follow-up, legal receipts, guide corrections, and current-main CI-trigger policy. PR #57's required hosted checks had failed before runner allocation; no exact-current native pass or external legal approval is implied by the merge. Issue #37 remains open for the account-owner Actions billing/runner repair.
...
| #14 | Native disclosure and comprehension | Product + qualified reviewer | `LegalRegressionTests`; PR #34 + #57 | Integrated native receipt in `docs/qa/legal-review-followup.md` | PR #34/#57 merged; exact hosted native receipt missing | Worker and expert review |
| #15 | Three scopes, dates, cancellation, large text | iOS owner | `LegalConsentAndReportTests`, `NoOpenPeriodRuleTests`; PR #34 + #57 | Integrated native/UI receipts in `docs/qa/legal-review-followup.md` | PR #34/#57 merged; exact hosted native receipt missing | Rendered/user acceptance |
...
| #20 | PDF, preview, native share and receiver handoff | iOS owner | `LegalRegressionTests`, `ReportShareSessionTests`, `ReportTransferTests`; PR #34 + #57 | Integrated native/UI receipts in `docs/qa/legal-review-followup.md` | PR #34/#57 merged; exact hosted native receipt missing | Receiver/provider acceptance |
...
| #29 | Native wording plus adopted support/marketing practice | Product + support owner | Legal report/UI regressions; PR #34 + #57 | Integrated native/UI receipts in `docs/qa/legal-review-followup.md` | PR #34/#57 merged; exact hosted native receipt missing | Operational adoption |
| #30 | Rendered audience/safe-use alignment | Product owner | Legal UI regressions; PR #34 + #57 | Integrated native/UI receipts in `docs/qa/legal-review-followup.md` | PR #34/#57 merged; exact hosted native receipt missing | Store rating and marketing alignment |
| #31 | Focus, VoiceOver, text sizes and device evidence | Accessibility QA | `LegalJourneyTests`; PR #34 + #57 | Integrated simulator evidence in `docs/qa/legal-review-followup.md` | PR #34/#57 merged; exact hosted native receipt missing | Physical VoiceOver/device acceptance |
