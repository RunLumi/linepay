...
**Status (September 9, 2026):** The legal engineering line is merged into `origin/main` at `c2d422017740fc83d27a8c9a52ad3cb55520ef2c`. The relevant integration receipts are PR #57 (`79c5ed4a067276bd7c4388653e80ef1f98f44e7c`), PR #77 (`9a599f24b69df8d32ab3c6d976bdb2d3d92eca9b`), PR #78 (`6734e773755358ad2d240b83df7d22cebede5c82`), PR #79 (`3af21e9c11c9fdb9133499c8e7d7d5e4cebd5b8e`), PR #80 (`297e4a417da4dcd51df219a5752f211746f82fc6`), PR #81 (`431abfe6d3d8936817191cc77c00ea5766e1c57a`), PR #82 (`89293885d4fce8451a3bce86fda6447c768bedd2`), PR #83 (`3128ea33469a2d2218dccdbe75a10a5a8c56159c`), PR #84 (`8201c19e060fd19893a4a5de5f4c27b295ad8e3b`), and PR #86 (`c2d422017740fc83d27a8c9a52ad3cb55520ef2c`). PR #82 completes the safe later paycheck-review route for a closed period whose expected pay remains unresolved: confirmed facts are retained as explicitly `notComparable`, with no invented amount or reconciliation. PR #84/#86 harden iOS 18.5 UI evidence: the full two-test legal UI sequence passes locally after fixture-process isolation, Files-app teardown, scope-menu retries, and virtualization-safe lookups. The post-merge full run `34271113219` executed all portable/native work but failed only the pre-PR #86 suite-sequencing scope journey; its failure is the evidence addressed by PR #86. Offline controls and Pages pass. Hosted-account billing/spending-limit failures remain tracked separately in #37. These receipts do not constitute storefront, counsel, publisher, physical-device, provider, or external-ownership approval.
...
| #37 | Hosted jobs execute and retain artifacts | GitHub account owner | Earlier hosted attempts failed before steps; authorized self-hosted targeted-native run `34263817878` passed; full run `34271113219` executed and retained artifacts but failed the pre-PR #86 scope-sequencing journey | Focused artifacts are inspectable; PR #86 fixes the observed suite failure and needs a fresh full run | Open | Repair hosted account Billing/Plans or rerun the exact post-PR #86 head on the authorized runner, then retain full artifacts |
