...
**Status (September 9, 2026):** The legal engineering line is merged into `origin/main` at `8201c19e060fd19893a4a5de5f4c27b295ad8e3b`. The relevant integration receipts are PR #57 (`79c5ed4a067276bd7c4388653e80ef1f98f44e7c`), PR #77 (`9a599f24b69df8d32ab3c6d976bdb2d3d92eca9b`), PR #78 (`6734e773755358ad2d240b83df7d22cebede5c82`), PR #79 (`3af21e9c11c9fdb9133499c8e7d7d5e4cebd5b8e`), PR #80 (`297e4a417da4dcd51df219a5752f211746f82fc6`), PR #81 (`431abfe6d3d8936817191cc77c00ea5766e1c57a`), PR #82 (`89293885d4fce8451a3bce86fda6447c768bedd2`), PR #83 (`3128ea33469a2d2218dccdbe75a10a5a8c56159c`), and PR #84 (`8201c19e060fd19893a4a5de5f4c27b295ad8e3b`). PR #82 completes the safe later paycheck-review route for a closed period whose expected pay remains unresolved: confirmed facts are retained as explicitly `notComparable`, with no invented amount or reconciliation. PR #84 hardens iOS 18.5 UI evidence: exact focused result bundles pass the unresolved rollover, largest-text scope, and edited-work journeys after fixture-process isolation and virtualization-safe lookups. Offline controls and Pages pass. The broad iOS run `34263817820` is a historical failure receipt that motivated #84; the new full run `34271113219` was still executing at this update. Hosted-account billing/spending-limit failures remain tracked separately in #37. These receipts do not constitute storefront, counsel, publisher, physical-device, provider, or external-ownership approval.
...
| #31 | Focus, VoiceOver, text sizes and device evidence | Accessibility QA | `LegalJourneyTests`; PR #34/#57/#84 | iOS 18.5 focused largest-text result passes after PR #84; physical VoiceOver/device acceptance remains open | Controls merged through PR #84 | Physical VoiceOver/device acceptance |
...
| #37 | Hosted jobs execute and retain artifacts | GitHub account owner | Earlier hosted attempts failed before steps; authorized self-hosted targeted-native run `34263817878` passed; PR #84 full run `34271113219` was executing at update | Focused artifacts are inspectable; broad full-gate outcome remains pending | Open | Repair hosted account Billing/Plans or document an approved durable runner policy, then retain full artifacts |
