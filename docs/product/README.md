...
| Determine whether a feature works today | [Coverage and gaps](payroll/coverage-and-gaps.md) | [Remediation status](../plan/ios-1.0-remediation.md), source and tests at the candidate commit |
