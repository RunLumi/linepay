...
This deliberately replaces the previous no-calendar-trial decision and the blanket ban on an onboarding offer. It aligns with the annual-trial hypothesis in [marketing.md](../growth/marketing.md). [pricing.md](pricing.md) owns prices and Free/Pro access; this file owns the experience. [The iOS plan](../plan/ios-1.0.md) and QA checklists must use the same decision.
