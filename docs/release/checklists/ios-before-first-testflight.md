...
Execution procedure: [Release and TestFlight through the Apple API](../api-and-testflight.md). Complete this checklist before distribution; a successful API upload alone is not readiness evidence.
