...
Reusable procedure: [Release and TestFlight through the Apple API](../api-and-testflight.md). This record is a dated snapshot, not a current-state assertion for subsequent runs.
...
- Subsequent repository tests in PR #5 explicitly record RULE-SCOPE and AUDIT-SCOPE product gaps; see [testing.md](../../testing/README.md). Build 2 predates those test/fix changes. This submission does not establish correct effective-dated rate editing, complete component reconciliation, or full release-readiness.
