...
The follow-up application candidate `5c51fdef140eb2835d05760e1f113c44aa1bb6a0` was used as the source context for targeted guide corrections covering the first-run onboarding route, Apple/local-data billing wording, and unresolved-calculation period closure guidance. The latest guide-content tree is `2208a970238531bb9490d06ae30939c938917f10` (a guide-only follow-up commit); Hugo static checks, CSS fixtures, and browser smoke passed on this content. These are narrow issue-#60 fixes, not a complete review of all 20 guides; the full-site candidate source map and manual walkthrough remain pending.
